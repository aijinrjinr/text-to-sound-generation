...
def get_args():
    ...
    parser.add_argument('--output', type=str, default='/data/wei/audiocaps/OUTPUT',
...
def main():
    args = get_args()
    args.name = 'caps_train'
    args.config_file = '/home/wei/TTSS/Diffsound/configs/caps.yaml'
    args.tensorboard = True
    args.load_path = None#'/data/wei/audiocaps/trained_model/'
    args.output = '/data/wei/audiocaps/OUTPUT'
    args.gpu = 0
