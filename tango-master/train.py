...
def main():
    ...
    args.hf_model = 'declare-lab/tango-full-ft-audiocaps'
    if args.hf_model:
    ...
    vae, stft, model, optimizer, lr_scheduler = accelerator.prepare(
        vae, stft, model, optimizer, lr_scheduler, device_placement=[args.device, args.device, args.device, args.device, args.device]
    )
