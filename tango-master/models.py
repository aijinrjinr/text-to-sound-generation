...
from CLAP.src.laion_clap.clap_module.model import CLAP
...
from transformers import CLIPTextModel, T5EncoderModel, AutoModel, CLIPTextConfig
...
class AudioDiffusion(nn.Module):
    def __init__(
        ...
        #     self.tokenizer = AutoTokenizer.from_pretrained(self.text_encoder_name)
        #     self.text_encoder = laion_clap.c
        else:
            self.tokenizer = AutoTokenizer.from_pretrained(self.text_encoder_name)
