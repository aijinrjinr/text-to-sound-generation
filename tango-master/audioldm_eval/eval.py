...
class EvaluationHelper:
    ...
    def get_filename_intersection_ratio(
        ...
        data_dict1 = {os.path.basename(x)[7:]: x for x in self.datalist1}
    ...
    def calculate_metrics(self, generate_files_path, groundtruth_path, same_name, limit_num=None):
        ...
        # if cfg.have_kl:
        # metric_psnr_ssim = float('nan')#self.calculate_psnr_ssim(pairedloader, same_name=same_name)
...
if __name__ == "__main__":
    ...
    args.target_audio_path = r'/home/qywei/TTSS/audiocaps/test/'
    # args.generation_result_path = r'/home/qywei/tango/outputs/test/Audiocaps_steps_200_guidance_3/'
    # args.generation_result_path = r'/home/qywei/tango/outputs/test/Audiocaps_clip__steps_200_guidance_3'
    args.generation_result_path = r'/home/qywei/tango/outputs/test/Diffsound_sample1'
    ...
    print(args.generation_result_path)
    print(metrics)
    a = 1
# '''