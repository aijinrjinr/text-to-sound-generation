...
class Cnn14(nn.Module):
    def __init__(
        ...
        # self.init_weight()
        # print("Remember to recover! load checkpoint!!!!!!!!!!!!!!!")
        if sample_rate == 16000:
            state_dict = torch.load('/home/qywei/tango/ckpt/Cnn14_16k_mAP=0.438.pth', 'cpu')
            self.load_state_dict(state_dict["model"])
        elif sample_rate == 32000:
            state_dict = torch.load("ckpt/Cnn14_mAP=0.431.pth", 'cpu')
            self.load_state_dict(state_dict["model"])
